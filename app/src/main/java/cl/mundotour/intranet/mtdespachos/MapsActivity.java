        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                if (markerPoints.size() >= 1) {
                    ...
                    float lattitude = Float.parseFloat(intent.getStringExtra("latitude"));
                    float longitude = Float.parseFloat(intent.getStringExtra("longitude"));
                    // Añade marcador en el destino
                    LatLng destino = new LatLng(lattitude, longitude);
...
//         mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(destino, zoomLevel));
//     }
// }
